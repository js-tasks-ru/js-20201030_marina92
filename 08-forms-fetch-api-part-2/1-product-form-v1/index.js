...
export default class ProductForm {element;
  subElements = {};
  defaultFormData = {
    title: '',
    description: '',
    ...
    return `
      ...
      <form data-element="productForm" class="form-grid">
        ...
        <div class="form-group form-group__wide">
          ...
          <div data-element="imageListContainer">${this.createImagesList()}</div>
  ...
  createImagesList() {
    ...
    const items = images.map(({ url, source }) => this.getImageItem(url, source).outerHTML).join('');
